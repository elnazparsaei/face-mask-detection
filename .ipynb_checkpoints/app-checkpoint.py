...
#RGB_img = []  # Define RGB_img globally
...
def mask_image():
    ...
    blob = cv2.dnn.blobFromImage(image, 1, (300, 300), (104.0, 177.0, 123.0))#convert to needed foramt for cv2

    print("[INFO] computing face detections...")
    net.setInput(blob) # extract the faces
    detections = net.forward() # extract the faces
    ...
    if confidence > 0.5:
        ...
        cv2.putText(image, label, (startX, startY - 10), 
                        cv2.FONT_HERSHAY_SIMPLEX, 0.45, color, 2)
...
def mask_detection():
    ...
    if choice == 'image':
        ...
        if image_file is not None:
            ...
            im = our_image.save('./images/pic4.jpeg')
